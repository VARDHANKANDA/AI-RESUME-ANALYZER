...
class ResumeAnalysis(Base):
    ...
    matching_keywords: Mapped[list | None] = mapped_column(JSONB, nullable=True)
    ...
    grammar_suggestions: Mapped[list | None] = mapped_column(JSONB, nullable=True)
    formatting_suggestions: Mapped[list | None] = mapped_column(JSONB, nullable=True)
    readability_feedback: Mapped[list | None] = mapped_column(JSONB, nullable=True)
    career_suggestions: Mapped[list | None] = mapped_column(JSONB, nullable=True)
    ai_suggestions: Mapped[list | None] = mapped_column(JSONB, nullable=True)
    optimized_sections: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
